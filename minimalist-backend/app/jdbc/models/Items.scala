...
object Items extends SQLSyntaxSupport[Items] {
  ...
  override val columns = Seq("item_id", "minimalist_id", "item_name", "item_comment", "item_quantity", "item_status", "created_at", "updated_at")
  ...
  def create(
    ...
    itemStatus: String,
    createdAt: Option[ZonedDateTime] = None,
    updatedAt: Option[ZonedDateTime] = None)(implicit session: DBSession = autoSession): Items = {
